...
* $\beta_2$: The log-rate ratio for every year increase for a typical individual in treatment group 0 is `r sum_glme_skin$coefficients[3,1]`, holding all other variables constant. 
